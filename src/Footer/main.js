...
const Footer = () => {
    return (
        <footer className="section footer-classNameic context-dark bg-image" style={{WIDTH:'100%',background: '#273c75',marginTop:'50px'}}>
            <div className="container">
                <div className="row row-30">
                    <div className="col-md-4 col-xl-5">
                        <div className="pr-xl-4"><a className="brand" href="index.html"><img className="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" />
